        ...
        public bool AddCustomer(int customerId, string name, string ad1, string ad2, string city, string postal, string country, string phone)
        {
            ...
            else
            {
                ...
                using (var connection2 = Connection.CreateAndOpen())
                {
                    ...
                    try
                    {
                        cmd = new MySqlCommand(countryString, connection2);
                        ...
                        cmd = new MySqlCommand(cityString, connection2);
                        ...
                        cmd = new MySqlCommand(addrString, connection2);
        ...
        public bool DeleteCustomer(int cust, int addr, int city, int cntry)
        {
            ...
            using (var connection2 = Connection.CreateAndOpen())
            {
                ...
                try
                {
                    ...
                    cmd = new MySqlCommand(custcheck, connection2);
                    ...
                    cmd = new MySqlCommand(addrcheck, connection2);
                    ...
                    cmd = new MySqlCommand(citycheck, connection2);
                    cmd.Parameters.AddWithValue("@city", city);
                    reader = cmd.ExecuteScalar();
                    if (reader == null)
                    {
                    ...
                    cmd = new MySqlCommand(cntrycheck, connection2);
